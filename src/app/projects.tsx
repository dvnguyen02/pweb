...
const projects = [
  ...
  {
    coverImage: "/images/projects/1.png",
    name: "Kidney Stone Prediction Model 🏥",
    description:
  ...
  {
    coverImage: "/images/projects/1.png",
    name: "PB Tech Laptop Scraper 🕷️",
    description:
      "A Python web scraper for collecting laptop product information from PB Tech's website, with plans to expand to all products.",
  ...
  },
  {
    ...
    description:
      "A Discord bot that leverages locally-hosted Large Language Models for natural language processing and conversational AI.",
