  ...
  return (
    <div className="w-full h-full flex flex-col items-center px-4 sm:px-6">
      <div className="flex flex-col gap-6 max-w-2xl w-full">
        <div ref={contactRef} className={`flex flex-col gap-4 p-4 sm:p-6 border border-border/80 rounded-lg bg-card transition-opacity duration-700 ease-out ${showContact ? 'opacity-100 animate-fade-in-up' : 'opacity-0 translate-y-8 pointer-events-none'}`}>
