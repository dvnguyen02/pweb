...
export default function Page() {
	...
	return (
		...
		>
			...
			>
				<div className="animate-in fade-in zoom-in-95 rounded-2xl bg-background backdrop-blur-lg shadow-2xl w-full sm:max-w-2xl lg:max-w-[60vw] h-full max-h-[90vh] sm:max-h-96 lg:max-h-[70vh] overflow-hidden ring-4 ring-neutral-500 hover:ring-neutral-600 dark:ring-neutral-700 dark:hover:ring-neutral-600 transition-all duration-1000 flex flex-col">
					...
					<div className="bg-primary/10 border-t border-neutral-400 dark:border-border/50 px-2 sm:px-3 py-1.5 flex items-center justify-between text-xs font-mono flex-shrink-0">
