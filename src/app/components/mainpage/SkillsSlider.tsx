    ...
    const allTechStacks = [...skills, ...frameworks];    return (
        <>
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="relative w-full mt-2 mb-6 space-y-4">                {/* First Row - Languages & Core Technologies */}
                <div className="w-full overflow-hidden slider-mask">
                    <div className="flex animate-scroll">
                        <ul className="flex items-center justify-center md:justify-start flex-shrink-0">                            {skills.map((tech, index) => (
                                <li
                        ...
                        <ul className="flex items-center justify-center md:justify-start flex-shrink-0" aria-hidden="true">                            {skills.map((tech, index) => (
                                <li
                ...
                </div>                {/* Second Row - Frameworks & Tools */}
                <div className="w-full overflow-hidden slider-mask">
                    <div className="flex animate-scroll-reverse">
                        <ul className="flex items-center justify-center md:justify-start flex-shrink-0">                            {frameworks.map((tech, index) => (
                                <li
                        ...
                        <ul className="flex items-center justify-center md:justify-start flex-shrink-0" aria-hidden="true">                            {frameworks.map((tech, index) => (
                                <li
